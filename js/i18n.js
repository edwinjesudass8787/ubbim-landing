(function() {
  ...
  const translations = {
    ...
    ms: {
      ...
      // Page headers
      'page-bes-badge': 'Perkhidmatan',
      'page-bes-title-1': 'Perkhidmatan ',
      'page-bes-title-2': 'Persekitaran Binaan',
      'page-bes-subtitle': 'Penyelesaian Komprehensif untuk Setiap Peringkat Pembinaan dan Pembangunan Infrastruktur',
      'page-digital-badge': 'Perkhidmatan',
      'page-digital-title-1': 'Penyelesaian ',
      'page-digital-title-2': 'Digital',
      'page-digital-subtitle': 'Penyelesaian Teknologi Inovatif untuk Persekitaran Binaan',
      'page-training-badge': 'Perkhidmatan',
      'page-training-title-1': 'Latihan & ',
      'page-training-title-2': 'Pembangunan',
      'page-training-subtitle': 'Memperkasakan Profesional Pembinaan Melalui Pembelajaran CPD Berterusan',
      'page-projects-badge': 'Portfolio',
      'page-projects-title-1': 'Projek ',
      'page-projects-title-2': 'Kami',
      'page-projects-subtitle': 'Terokai Kisah Kejayaan Kami dalam Persekitaran Binaan dan Inovasi Digital',
      'page-esg-badge': 'Alam Sekitar, Sosial & Tadbir Urus',
      'page-esg-title-1': 'Membina ',
      'page-esg-title-2': 'Masa Depan yang Lebih Baik',
      'page-esg-subtitle': 'Di UBBIM, kemampanan bukan sekadar kata hiasan — ia terintegrasi dalam cara kami beroperasi, memberi balik dan mentadbir.',
      'page-awards-badge': 'Pengiktirafan',
      'page-awards-title-1': 'Anugerah & ',
      'page-awards-title-2': 'Pengiktirafan',
      'page-awards-subtitle': 'Di UBBIM Resources, setiap pencapaian mencerminkan komitmen kami yang teguh terhadap inovasi, kemampanan dan transformasi digital dalam persekitaran binaan.',
